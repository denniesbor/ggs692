...
const addRestaurantMarkers = async () => {
  ...
  data.features.forEach((feature) => {
    ...
    markersL.addLayer(markerL); // Add iterated markers into a layer group
  });

  mapL.addLayer(markersL); // Add MarkerClusterGroup to the Leaflet map
...
info.update = function (props) {
  ...
  this._div.innerHTML =
    "<h4>Restaurant</h4>" +
    (props
      ? "<b>" + props.NAME + "</b><br>" + "<h4> Cuisine </h4>" + props.CUISINE
